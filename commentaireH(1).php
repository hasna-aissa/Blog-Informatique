...
$insertmsg = $bdd->prepare('INSERT INTO commentaire_ai(Nom,commentaire,Email,siteweb,date_post) VALUES(?,?,?,?,NOW())');
...
<?php
$allmsg=$bdd->query('SELECT * FROM commentaire_ai');
