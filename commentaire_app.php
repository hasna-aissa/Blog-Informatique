...
$insertmsg = $bdd->prepare('INSERT INTO commentaire_app(Nom,commentaire,Email,siteweb) VALUES(?,?,?,?)');
...
<form method="POST" action="">
	...
	<textarea name="commentaire" placeholder="votre commentaire.." rows="12" cols="110" style="border: 2px solid black" required></textarea><br/>
	<input type="submit" value="poster mon commentaire" name="submit_commentaire" style="background-color: grey;border-radius: 10px" />
	</fieldset>
	
</form>
<?php
$allmsg=$bdd->query('SELECT * FROM commentaire_app');
